# eyeless-jack 地毯式排查记录

- 游戏目录：D:\游戏\eyeless-jack
- 时间：2026-08-12 01:14:51

## 1 识别
- 文本文件：1 · 二进制资源：19
- 识别条目：194
- 形态统计：
  - asset_unity: 29 文件 / 691 条
  - mono_csharp: 1 文件 / 88 条
  - mono_other: 20 文件 / 0 条
- 状态分布：
  - pending: 194
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：194 · 完成：193（记忆命中 0） · 失败：1
- 请求：132 · 输入 5432 tokens · 输出 1527 tokens
- 耗时：49.2s · 吞吐 235 条/分

## 3 写回
- 文本文件：1 · 写入译文：193
- 输入保护：True · 重开验证：True · 变更文件：48
