# containment-breach-hd-edition 地毯式排查记录

- 游戏目录：D:\游戏\containment-breach-hd-edition
- 时间：2026-08-11 06:59:47

## 1 识别
- 文本文件：17 · 二进制资源：20
- 识别条目：3126
- 形态统计：
  - asset_unity: 17 文件 / 2018 条
  - mono_csharp: 1 文件 / 0 条
  - mono_other: 17 文件 / 490 条
- 状态分布：
  - pending: 3126
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：3126 · 完成：3126（记忆命中 0） · 失败：0
- 请求：1950 · 输入 76956 tokens · 输出 20454 tokens
- 耗时：1057.4s · 吞吐 177 条/分

## 3 写回
- 文本文件：17 · 写入译文：3014
- 输入保护：True · 重开验证：True · 变更文件：64
