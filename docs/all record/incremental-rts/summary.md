# incremental-rts 地毯式排查记录

- 游戏目录：D:\游戏\incremental-rts
- 时间：2026-08-13 05:34:30
...
- 语言分布（抽样预检，多语言游戏盲区）：
  ...
  - 其他/无字母: 40 条
- 形态统计：
  - asset_unity: 9 文件 / 0 条
  - mono_csharp: 1 文件 / 0 条
  - mono_other: 40 文件 / 0 条
- 状态分布：
  - pending: 850
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：850 · 完成：804（记忆命中 7） · 失败：46
- 请求：1087 · 输入 52598 tokens · 输出 14341 tokens
- 耗时：1192.2s · 吞吐 40 条/分
