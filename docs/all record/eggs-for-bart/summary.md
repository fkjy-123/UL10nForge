# eggs-for-bart 地毯式排查记录

- 游戏目录：D:\游戏\eggs-for-bart
- 时间：2026-08-11 22:51:41

## 1 识别
- 文本文件：1 · 二进制资源：17
- 识别条目：134
- 形态统计：
  - asset_unity: 47 文件 / 349 条
  - mono_csharp: 2 文件 / 99 条
- 状态分布：
  - pending: 134
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：134 · 完成：134（记忆命中 0） · 失败：0
- 请求：120 · 输入 5188 tokens · 输出 1908 tokens
- 耗时：107.3s · 吞吐 75 条/分

## 3 写回
- 文本文件：1 · 写入译文：118
- 输入保护：True · 重开验证：True · 变更文件：43
