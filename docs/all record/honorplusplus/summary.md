# honorplusplus 地毯式排查记录

- 游戏目录：D:\游戏\honorplusplus
- 时间：2026-08-13 04:51:33
...
- 语言分布（抽样预检，多语言游戏盲区）：
  ...
  - 重音拉丁（法/西/德等）: 2 条
- 形态统计：
  - asset_unity: 11 文件 / 0 条
  - mono_csharp: 2 文件 / 0 条
  - mono_other: 114 文件 / 2 条
- 状态分布：
  - pending: 529
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：529 · 完成：499（记忆命中 22） · 失败：30
- 请求：436 · 输入 17223 tokens · 输出 4236 tokens
- 耗时：417.7s · 吞吐 72 条/分

## 3 写回
- 文本文件：1 · 写入译文：475
- 输入保护：True · 重开验证：True · 变更文件：63
- 总体闸门：PASS · 字体：runtime_verified（LEGACY_EVIDENCE_UNSCOPED：旧协议证据，未含逐码点 attestation/覆盖证明）

## 3.5 语义审核（翻译质量升级）
- 审核条数：68 · 不合格：13 · 术语沉淀：5
