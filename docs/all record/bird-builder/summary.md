# bird-builder 地毯式排查记录

- 游戏目录：D:\游戏\bird-builder
- 时间：2026-08-11 01:58:21

## 1 识别
- 文本文件：1 · 二进制资源：1
- 识别条目：28
- 形态统计：
  - asset_unity: 3 文件 / 30 条
...
## 2 翻译
- 总条目：28 · 完成：28（记忆命中 0） · 失败：0
- 请求：5 · 输入 144 tokens · 输出 19 tokens
- 耗时：2.7s · 吞吐 620 条/分

## 3 写回
- 文本文件：1 · 写入译文：26
- 输入保护：True · 重开验证：True · 变更文件：29
