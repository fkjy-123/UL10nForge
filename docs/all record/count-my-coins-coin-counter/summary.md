# count-my-coins-coin-counter 地毯式排查记录

- 游戏目录：D:\游戏\count-my-coins-coin-counter
- 时间：2026-08-11 13:36:42

## 1 识别
- 文本文件：1 · 二进制资源：8
- 识别条目：389
- 形态统计：
  - asset_unity: 3 文件 / 1087 条
  - mono_csharp: 2 文件 / 17 条
  - mono_other: 31 文件 / 1214 条
- 状态分布：
  - pending: 389
  - translated: 0
  - failed: 0
...
## 2 翻译
- 总条目：389 · 完成：389（记忆命中 0） · 失败：0
- 请求：345 · 输入 13156 tokens · 输出 3323 tokens
- 耗时：125.9s · 吞吐 185 条/分
