...
- 直接应用：28 条（采纳 28 / 拒绝 0）
- 退休：0（被质量门拒绝 ≥2 次，不可信）

## 2 记忆库状态（按类型 × 状态）

- phrase: active 243 · pending 1306 · retired 3
...
| Creative Commons Legal Code | r:display | Creative Commons 法律条款 | 3 | 1 | 0 | foxhunt-chapter1/goodmorning |
| CC0 1.0 Universal | r:display | CC0 1.0 通用版 | 3 | 1 | 0 | foxhunt-chapter1/goodmorning |
| CREATIVE COMMONS CORPORATION IS NOT A LAW FIRM AND DOES NOT PROVIDE | r:display | Creative Commons Corporation 并非律师事务所，也不提供任何法律服务。 | 3 | 1 | 0 | foxhunt-chapter1/goodmorning |
