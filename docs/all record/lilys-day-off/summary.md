# lilys-day-off 地毯式排查记录

- 游戏目录：D:\游戏\lilys-day-off
- 时间：2026-08-14 17:07:09
...
## 2 翻译
- 总条目：1225 · 完成：1185（记忆命中 0） · 失败：3
- 请求：0 · 输入 0 tokens · 输出 0 tokens
- 耗时：0.0s · 吞吐 0 条/分

## 3 写回
- 文本文件：2 · 写入译文：1178
- 输入保护：True · 重开验证：True · 变更文件：79
- 总体闸门：PASS · 字体：payload_deployed
- 字体发布门：PASS — 覆盖 COVERED：1 个消费者完整，0 个未覆盖，缺字 0 个码点

## 3.5 语义审核（翻译质量升级）
- 审核条数：98 · 不合格：2 · 术语沉淀：0
